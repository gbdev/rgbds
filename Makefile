...
.c.d:
	$Q${CC} ${REALCFLAGS} -MM -MF $@ -MG -MP -MQ $*.o -MQ $@ $<

# Automatic dependency generation because keeping track of headers is a huge pain

ifneq ($(MAKECMDGOALS),clean)
include src/asm/asmy.d
include src/asm/charmap.d
include src/asm/constexpr.d
include src/asm/fstack.d
include src/asm/globlex.d
include src/asm/lexer.d
include src/asm/main.d
include src/asm/math.d
include src/asm/output.d
include src/asm/rpn.d
include src/asm/symbol.d
include src/asm/util.d

include src/link/assign.d
include src/link/library.d
include src/link/main.d
include src/link/mapfile.d
include src/link/object.d
include src/link/output.d
include src/link/patch.d
include src/link/parser.d
include src/link/script.d
include src/link/symbol.d

include src/fix/main.d

include src/gfx/gb.d
include src/gfx/main.d
include src/gfx/makepng.d

include src/extern/err.d
include src/extern/utf8decoder.d

include src/version.d
endif
...
clean:
	$Q${RM} rgbasm rgbasm.exe ${rgbasm_obj} src/asm/*.d
	$Q${RM} rgblink rgblink.exe ${rgblink_obj} src/link/*.d
	$Q${RM} rgbfix rgbfix.exe ${rgbfix_obj} src/fix/*.d
	$Q${RM} rgbgfx rgbgfx.exe ${rgbgfx_obj} src/gfx/*.d
	$Q${RM} src/extern/*.o src/extern/*.d
	$Q${RM} src/*.o src/*.d
